...
#'
#' ChIP-Enrich is designed for use with narrow genomic regions where fewer
#' genes have an intersecting genomic region. ChIP-seq experiments
#' for transcription factors with fewer peaks, and fewer peaks per gene are the
#' intended use case. For more details, see the 'ChIP-Enrich
