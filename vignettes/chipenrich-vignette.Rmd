...
```{r include=FALSE}
devtools::load_all("C:/Users/wangdaha/Documents/chipenrich/")
devtools::load_all("C:/Users/wangdaha/Documents/chipenrich.data/")
```
...
results = broadenrich(peaks = peaks_H3K4me3_GM12878, genome = 'hg19', genesets = "biocarta_pathway", locusdef = "nearest_tss", qc_plots = FALSE, out_name = NULL, n_cores=1)
...
# Without mappability
#gs_path = system.file('extdata','vignette_genesets.txt', package='chipenrich')
results = chipenrich(peaks = peaks_E2F4, genome = 'hg19', genesets = "biocarta_pathway",locusdef = "nearest_tss", qc_plots = FALSE, out_name = NULL, n_cores = 1)
...
# With mappability
#gs_path = system.file('extdata','vignette_genesets.txt', package='chipenrich')
results = chipenrich(peaks = peaks_E2F4, genome = 'hg19', genesets = "biocarta_pathway", locusdef = "nearest_tss", mappability=24, qc_plots = FALSE,out_name = NULL,n_cores=1)
...
```{r, warning = FALSE, message = FALSE}
#gs_path = system.file('extdata','vignette_genesets.txt', package='chipenrich')
results = polyenrich(peaks = peaks_E2F4, genome = 'hg19', genesets = "biocarta_pathway", method = 'polyenrich', locusdef = "nearest_tss", qc_plots = FALSE, out_name = NULL, n_cores = 1)
...
```{r, warning = FALSE, message = FALSE}
#gs_path = system.file('extdata','vignette_genesets.txt', package='chipenrich')
results = hybridenrich(peaks = peaks_E2F4, genome = 'hg19', genesets = "biocarta_pathway", locusdef = "nearest_tss", qc_plots = F, out_name = NULL, n_cores = 1)
...
```{r, warning = FALSE, message = FALSE}
#gs_path = system.file('extdata','vignette_genesets.txt', package='chipenrich')
results.prox = proxReg(peaks_E2F4, reglocation = 'tss',	genome = 'hg19', genesets="biocarta_pathway", out_name=NULL)
...
#gs_path = system.file('extdata','vignette_genesets.txt', package='chipenrich')
results = chipenrich(peaks = peaks_E2F4, genome = 'hg19', genesets = "biocarta_pathway",
